...
typedef void(^AspectBlock)(id<AspectInfo> info);
...
+ (instancetype)identifierWithSelector:(SEL)selector object:(id)object options:(AspectOptions)options block:(void(^)(id<AspectInfo> info))block error:(NSError **)error;
...
static id aspect_add(id self, SEL selector, AspectOptions options, AspectBlock block, NSError * __autoreleasing *error) {
...
+ (instancetype)identifierWithSelector:(SEL)selector object:(id)object options:(AspectOptions)options block:(AspectBlock)block error:(NSError **)error {
    NSCParameterAssert(block);
    NSCParameterAssert(selector);
